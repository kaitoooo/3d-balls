...
export default class WebGL {
    ...
    three: {
        ...
        clock: THREE.Clock;
        basketballMesh: THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]> | null;
        soccerballMesh: THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]> | null;
        volleyballMesh: THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]> | null;
    ...
    setModels(): void {
        ...
        loader.load(this.srcObj, (obj) => {
            ...
            // 3dメッシュのサイズ
            this.three.basketballMesh.scale.set(1, 1, 1);
            this.three.soccerballMesh.scale.set(0.8, 0.8, 0.8);
            this.three.volleyballMesh.scale.set(0.7, 0.7, 0.7);

            // 3dメッシュの位置
            this.three.basketballMesh.position.set(0, 0, 0);
            this.three.soccerballMesh.position.set(this.sp ? -2.3 : -3, 0, 0);
            this.three.volleyballMesh.position.set(this.sp ? 2.3 : 3, 0, 0);

            // 3dメッシュの角度
            this.three.basketballMesh.rotation.set(0, 0, 0);
            this.three.soccerballMesh.rotation.set(0, 0, 0);
            this.three.volleyballMesh.rotation.set(0, 0, 0);
    ...
    rendering(): void {
        ...
        this.three.basketballMesh.position.y += Math.sin(time) * -0.002;
        this.three.soccerballMesh.position.y += Math.sin(time) * 0.003;
        this.three.volleyballMesh.position.y += Math.cos(time) * -0.004;

        this.three.basketballMesh.rotation.z += Math.sin(time) * -0.002;
        this.three.basketballMesh.rotation.y += 0.006;
        this.three.soccerballMesh.rotation.z += Math.sin(time) * 0.003;
        this.three.soccerballMesh.rotation.y -= 0.004;
        this.three.volleyballMesh.rotation.z += Math.cos(time) * -0.004;
        this.three.volleyballMesh.rotation.y -= 0.008;
    ...
    resetModels(): void {
        ...
        gsap.to(this.three.soccerballMesh.scale, {
            x: 0.8,
            y: 0.8,
            z: 0.8,
            duration: 1,
        ...
        gsap.to(this.three.volleyballMesh.scale, {
            x: 0.7,
            y: 0.7,
            z: 0.7,
            duration: 1,
        ...
        gsap.to(this.three.soccerballMesh.position, {
            x: this.sp ? -2.3 : -3,
            y: 0,
            z: 0,
            duration: 1,
        ...
        gsap.to(this.three.volleyballMesh.position, {
            x: this.sp ? 2.3 : 3,
            y: 0,
            z: 0,
            duration: 1,
        ...
        gsap.to(this.three.soccerballMesh.rotation, {
            x: 0,
            y: 0,
            z: 0,
        });
        gsap.to(this.three.volleyballMesh.rotation, {
            x: 0,
            y: 0,
            z: 0,
        });
